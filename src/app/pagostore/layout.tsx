...
export const metadata: Metadata = {
  title: 'Diamantes Free Fire baratos · PagoStore',
  description: 'Recarga diamantes de Free Fire al mejor precio, con entrega rapida y pago en tu moneda local. Atendido por el clan La Elite PvP.',
  alternates: { canonical: '/pagostore' },
  openGraph: {
    title: 'Diamantes Free Fire baratos · PagoStore',
    description: 'Recarga diamantes de Free Fire al mejor precio, con entrega rapida y pago en tu moneda local. Atendido por el clan La Elite PvP.',
    url: '/pagostore',
